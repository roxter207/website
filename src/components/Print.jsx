        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-20 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
              Our Advanced <br />{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">Printing & Packing</span>
            </h2>
            ...
            <p className="text-white text-base md:text-lg leading-relaxed">
              ...
              corridors and equipped with state-of-the-art technology to deliver
            ...
            <p className="text-white text-base md:text-lg leading-relaxed">
              ...
              <span className="font-semibold text-white">
                Xerox 700 and Versant colour printers, a Xante envelope printer,
                Duplo cutter/scanner, digital trimmer,
              </span>{" "}
              and{" "}
              <span className="font-semibold text-white">
