      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            MDM is passionate about enriching the employee experience by
            offering the most relevant and diversified resources available in
            the industry. Our organization clearly communicates its values and
            expectations, holds its employees to the highest standards, and
        ...
        >
          ...
          >
            ...
            <p className="text-gray-800 text-sm sm:text-base">
              We support the career development of all staff through diverse
        ...
        >
          <motion.button
            ...
            className="px-10 py-4 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold text-lg shadow-lg hover:shadow-2xl transition-all"
          >
            Apply Now
          </motion.button>
        </motion.div>
